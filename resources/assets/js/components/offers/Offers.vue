    ...
    <div class="col-12 col-lg-9 row p-0 m-0">    
        <div class="red-ribbon col-12">
            <div class="logo-square" >
                <v-lazy-image src="/storage/images/app/offer-tag.png" alt="Ofertas de Bazar Mayorista Maju"></v-lazy-image>
            </div>
        ...
        <div class="col-12 mt-4 row">
            <div class="col-12 col-lg-4 mt-2" v-for="p in products" :key="p.code">
                <productCard class="border-grey ml-4 ml-lg-0" :product="p"></productCard>
            </div>
        </div>
    </div>
